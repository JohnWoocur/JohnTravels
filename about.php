      ...
      <div id="page" class="full-page">
         ...
         <main id="content" class="site-main">
            ...
            <section class="inner-banner-wrap">
               <div class="inner-baner-container" style="background-image: url(assets/images/bannaer_1.jpg);">
                  <div class="container">
            ...
            <section class="about-section about-page-section">
               <div class="about-service-wrap">
                  <div class="container">
                     <div class="section-heading">
                        <div class="row align-items-end">
                           <div class="col-lg-6">
                              ...
                              <h2>HELLO WOOCURS!</h2>
							  <h2>OUR TRAVELS HAS BEEN PRESENT BEST IN THE MARKET</h2>
                           </div>
                           <div class="col-lg-6">
                           ...
                           <div class="col-lg-4">
                              <div class="about-service">
                                 ...
                                 <div class="about-service-content">
                                    ...
                                    <p>Some help with unparalleled quality and an excursion worth your cash.</p>
                                 </div>
                              </div>
                           </div>
                           <div class="col-lg-4">
                     ...
                     <div class="about-video-wrap" style="background-image: url(assets/images/about.mp4);">
