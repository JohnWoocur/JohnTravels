                        ...
                        <div class="banner-content-wrap">
                           <div class="container">
                              <div class="banner-content text-center">
                                 <h2 class="banner-title">EXPLORE THE PEARL OF INDIAN OCEAN.</h2>
                                 <p>Experience the adventures of Mirabilis, eat , sleep apart from these - Hiking, Climing, flying, jumping, swimming, Snorkling, surfing, diving.</p>
                  ...
                  <div class="home-banner-items">
                     <div class="banner-inner-wrap" style="background-image: url(assets/images/slider-banner-2.jpg);"></div>
                        <div class="banner-content-wrap">
                           <div class="container">
                              <div class="banner-content text-center">
                                 <h2 class="banner-title">LET'S MAKE MEMORIES, LET IT MORE ADVENTURES , ROMANTIC, MEMORABLE</h2>
                                 <p>Experience the adventures of Mirabilis, eat , sleep apart from these - Hiking, Climing, flying, jumping, swimming, Snorkling, surfing, diving.</p>
                                 <a href="#" class="button-primary">CONTINUE READING</a>
                              </div>
                           </div>
                  ...
                  <div class="section-heading text-center">
                     <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                           ...
                           <p>The Packags will make you more comfortable in creating your memories While exploring new things - Mirabilis.</p>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="col-lg-7">
                        <div class="callback-inner">
                           <div class="section-heading section-heading-white">
                              ...
                              <p>Let's have a Trip - which will help you to Explore new world - Mirabilis.</p>
                           </div>
                  ...
                  <div class="section-heading text-center">
                     <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                           ...
                           <p>Enjoy our discount & BOUNS on your tours with more and more celeberation.</p>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col-lg-5">
                        <div class="section-heading">
                           ...
                           <p>The moments are captured,</p>
						   <p>The memories starts here,</p>
                  ...
                  <div class="row">
                     <div class="col-md-6 col-lg-4">
                        <article class="post">
                           ...
                           <div class="entry-content">
                              <h3>
                                 <a href="blog-single.php">Life is a beautiful journey not a destination</a>
                              </h3>
                     ...
                     <div class="col-md-6 col-lg-4">
                        <article class="post">
                           ...
                           <div class="entry-content">
                              <h3>
                                 <a href="blog-single.php">Take only memories, leave only footprints</a>
                              </h3>
                              <div class="entry-meta">
                                 <span class="byline">
                                    <a href="#">Demoteam</a>
                     ...
                     <div class="col-md-6 col-lg-4">
                        <article class="post">
                           ...
                           <div class="entry-content">
                              <h3>
                                 <a href="blog-single.php">Journeys are best measured in new friends</a>
                              </h3>
                              <div class="entry-meta">
                                 <span class="byline">
                                    <a href="#">Demoteam</a>
                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-8">
                        ...
                        <div class="contact-btn-wrap">
                           ...
                           <a href="career.php" class="button-primary">LEARN MORE</a>
                        </div>
                     </div>
                  </div>
               </div>
