               		...
               		<div class="col-lg-4 col-md-6">
               			<div class="guide-content-wrap text-center">
               				...
               				<div class="guide-content">
               					...
               					<p>Let's have a Trip - which will help you to Explore new world - Mirabilis. Ut elit tellus, luctus nec ullampor.</p>
                  ...
                  <div class="section-heading section-heading-white">
                     <div class="row">
                        <div class="col-lg-7">
                           ...
                           <a href="career.php" class="button-primary">JOIN US NOW</a>
                        </div>
                     </div>
                  </div>
               </div>
