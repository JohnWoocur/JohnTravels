                        ...
                        <div class="service-content-wrap">
                           <div class="service-content">
                              <div class="service-header">
                                 ...
                                 <h3>Explore New Places New Culture</h3>
                              </div>
                              <p>John Travels LK is a Tour Operator / Tour Agency in Sri Lanka which provides comfortable services to explore Srilanka with your wishes to create your Unforgettable memories.</p>
                           </div>
                           <figure class="service-img">
                              <img src="assets/images/img30.png" alt="">
                           </figure>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="service-content-wrap">
                           <div class="service-content">
                              <div class="service-header">
                                 ...
                                 <h3>Tailor Made and Customized Trips </h3>
                              </div>
                              <p>At the point when we say it's a tailor-made schedule we are not bluffing.But, we truly plunk down and try to ensure that it's an impeccable outing that we are making only for you.</p>
                           </div>
                           <figure class="service-img">
                     ...
                     <div class="col-md-6">
                        <div class="service-content-wrap">
                           <div class="service-content">
                              ...
                              <p>This makes us open to be adaptable and free to appropriately pay attention to our client’s necessities and plan. We see with respect to how we can utilize our ability to tailor make something that you depend on that we can do..</p>
                           </div>
                           <figure class="service-img">
                     ...
                     <div class="col-md-6">
                        <div class="service-content-wrap">
                           <div class="service-content">
                              ...
                              <p>Reach us at any time of the day and you’re sure to be guided by our friendly travel consultants with effective solutions to your travel problems.</p>
                           </div>
                           <figure class="service-img">
