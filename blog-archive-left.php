      ...
      <div id="page" class="full-page">
         ...
         <main id="content" class="site-main">
            ...
            <section class="inner-banner-wrap">
               <div class="inner-baner-container" style="background-image: url(assets/images/bannaer_2.jpg);">
                  <div class="container">
                              ...
                              <div class="grid-item col-md-6">
                                 <article class="post">
                                    ...
                                    <div class="entry-content">
                                       ...
                                       <a href="blog-single.php" class="button-text">CONTINUE READING..</a>
                                    </div>
                                 </article>
                              </div>
                              <div class="grid-item col-md-6">
                                 ...
                                 <article class="post">
                                    ...
                                    <div class="entry-content">
                                       ...
                                       <div class="entry-meta">
                                          ...
                                          <span class="comments-link">
                                             <a href="blog-single.php">No Comments</a>
                                          </span>
                                       </div>
                                       <p>Praesent, risus adipisicing donec! Cras. Lobortis id aliquip taciti repudiandae porro dolore facere officia! Natoque mollitia ultrices convallis nisl suscipit</p>
                                 ...
                                 <div class="widget-content text-center"> 
                                    <div class="profile"> 
                                       ...
                                       <div class="socialgroup"> 
                                          <ul> 
                                             <li> <a href="https://www.facebook.com/johntravelslk" target="blank"> <i class="fab fa-facebook"></i> </a> </li> 
                                             <li> <a href="https://www.youtube.com/@johntravelslk" target="blank"> <i class="fab fa-youtube"></i> </a> </li> 
                                             <li> <a href="https://www.instagram.com/john_travels_lk/" target="blank"> <i class="fab fa-instagram"></i> </a> </li> 
                                             <li> <a href="https://wa.me/message/JHT7ZVJLWFUUP1" target="blank"> <i class="fab fa-whatsapp"></i> </a> </li> 
                                          </ul> 
                                       </div> 
                                    </div> 
                                 </div>
